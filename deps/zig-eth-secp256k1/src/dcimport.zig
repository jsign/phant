...
pub const struct_secp256k1_context_struct = opaque {};
pub const secp256k1_context = struct_secp256k1_context_struct;
...
pub extern fn secp256k1_ecdsa_signature_parse_der(ctx: ?*const secp256k1_context, sig: [*c]secp256k1_ecdsa_signature, input: [*c]const u8, inputlen: usize) c_int;
pub extern fn secp256k1_ecdsa_signature_serialize_der(ctx: ?*const secp256k1_context, output: [*c]u8, outputlen: [*c]usize, sig: [*c]const secp256k1_ecdsa_signature) c_int;
pub extern fn secp256k1_ecdsa_signature_serialize_compact(ctx: ?*const secp256k1_context, output64: [*c]u8, sig: [*c]const secp256k1_ecdsa_signature) c_int;
pub extern fn secp256k1_ecdsa_verify(ctx: ?*const secp256k1_context, sig: [*c]const secp256k1_ecdsa_signature, msg32: [*c]const u8, pubkey: [*c]const secp256k1_pubkey) c_int;
pub extern fn secp256k1_ecdsa_signature_normalize(ctx: ?*const secp256k1_context, sigout: [*c]secp256k1_ecdsa_signature, sigin: [*c]const secp256k1_ecdsa_signature) c_int;
pub extern const secp256k1_nonce_function_rfc6979: secp256k1_nonce_function;
pub extern const secp256k1_nonce_function_default: secp256k1_nonce_function;
pub extern fn secp256k1_ecdsa_sign(ctx: ?*const secp256k1_context, sig: [*c]secp256k1_ecdsa_signature, msg32: [*c]const u8, seckey: [*c]const u8, noncefp: secp256k1_nonce_function, ndata: ?*const anyopaque) c_int;
pub extern fn secp256k1_ec_seckey_verify(ctx: ?*const secp256k1_context, seckey: [*c]const u8) c_int;
pub extern fn secp256k1_ec_pubkey_create(ctx: ?*const secp256k1_context, pubkey: [*c]secp256k1_pubkey, seckey: [*c]const u8) c_int;
pub extern fn secp256k1_ec_privkey_tweak_add(ctx: ?*const secp256k1_context, seckey: [*c]u8, tweak: [*c]const u8) c_int;
pub extern fn secp256k1_ec_pubkey_tweak_add(ctx: ?*const secp256k1_context, pubkey: [*c]secp256k1_pubkey, tweak: [*c]const u8) c_int;
pub extern fn secp256k1_ec_privkey_tweak_mul(ctx: ?*const secp256k1_context, seckey: [*c]u8, tweak: [*c]const u8) c_int;
...
pub extern fn secp256k1_ext_reencode_pubkey(ctx: ?*const secp256k1_context, out: [*c]u8, outlen: usize, pubkeydata: [*c]const u8, pubkeylen: usize) c_int;
pub extern fn secp256k1_ext_scalar_mul(ctx: ?*const secp256k1_context, point: [*c]u8, scalar: [*c]const u8) c_int;
...
pub const SECP256K1_INLINE = @compileError("unable to translate C expr: unexpected token 'inline'"); // /home/ignacio/code/zig-eth-secp256k1/libsecp256k1/include/secp256k1.h:113:11
pub const SECP256K1_WARN_UNUSED_RESULT = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/ignacio/code/zig-eth-secp256k1/libsecp256k1/include/secp256k1.h:134:11
pub const SECP256K1_ARG_NONNULL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/ignacio/code/zig-eth-secp256k1/libsecp256k1/include/secp256k1.h:139:11
...
pub inline fn SECP256K1_GNUC_PREREQ(_maj: anytype, _min: anytype) @TypeOf(((__GNUC__ << @as(c_int, 16)) + __GNUC_MINOR__) >= ((_maj << @as(c_int, 16)) + _min)) {
    return ((__GNUC__ << @as(c_int, 16)) + __GNUC_MINOR__) >= ((_maj << @as(c_int, 16)) + _min);
}
pub const SECP256K1_API = "";
pub const SECP256K1_FLAGS_TYPE_MASK = (@as(c_int, 1) << @as(c_int, 8)) - @as(c_int, 1);
pub const SECP256K1_FLAGS_TYPE_CONTEXT = @as(c_int, 1) << @as(c_int, 0);
pub const SECP256K1_FLAGS_TYPE_COMPRESSION = @as(c_int, 1) << @as(c_int, 1);
pub const SECP256K1_FLAGS_BIT_CONTEXT_VERIFY = @as(c_int, 1) << @as(c_int, 8);
pub const SECP256K1_FLAGS_BIT_CONTEXT_SIGN = @as(c_int, 1) << @as(c_int, 9);
pub const SECP256K1_FLAGS_BIT_COMPRESSION = @as(c_int, 1) << @as(c_int, 8);
pub const SECP256K1_CONTEXT_VERIFY = SECP256K1_FLAGS_TYPE_CONTEXT | SECP256K1_FLAGS_BIT_CONTEXT_VERIFY;
pub const SECP256K1_CONTEXT_SIGN = SECP256K1_FLAGS_TYPE_CONTEXT | SECP256K1_FLAGS_BIT_CONTEXT_SIGN;
